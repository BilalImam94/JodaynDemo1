...
@Feature("User")
public class TC4_UserLogOut extends TestBasic {
    ...
    public void logoutUser() throws IOException, ParseException {
        TC2_LoginWithCorrectCredentials.loginUserWithCorrectEmailAndPassword();
    ...
    private void verifyThatUserIsNavigatedToLoginPage() {
        String loginToYourAccountText = new LoggedIn(getDriver())
                .logoutButtonClick()
