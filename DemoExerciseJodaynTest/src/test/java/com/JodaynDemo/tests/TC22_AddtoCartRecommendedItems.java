...
@Feature("Cart")
public class TC22_AddtoCartRecommendedItems extends TestBasic {
    ...
    private void verifyRecommendedItemsAreVisible() {
        String recommendedItemsText = new Home(getDriver())
                .getRecommendedItems()
                .getText();
    ...
    private void verifyThatProductIsDisplayedInCartPage() {
        List<String> productsNames = new Home(getDriver())
